...
public abstract class Player implements Comparable<Player> {
    ...
    public int compareTo(Player p) {
        // YOUR CODE HERE 
        //https://stackoverflow.com/questions/61662766/can-i-use-the-compareto-to-compare-two-values-of-type-int
        int compare = Integer.valueOf(this.susLevel).compareTo(p.susLevel);
        return compare; // delete this once you have implemented this method
    }
